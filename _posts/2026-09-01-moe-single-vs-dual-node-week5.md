...
B300 한 장의 메모리가 288 GB이니 8장이면 2,304 GB다. FP8은 2,400 GB가 필요하다. **96 GB가 모자란다.** KV 캐시와 중간 계산값을 빼고 가중치만 계산해도 그렇다.
...
1. 2.4T 파라미터 모델은 FP8로는 GPU 8장 한 노드에 들어가지 않는다. 2,304 GB 대 2,400 GB로 96 GB가 모자란다.
