...
가장 크게 바뀐 인식은 이거다. 그동안 "AI 인프라"라고 하면 GPU 성능을 먼저 떠올렸는데, 추론 시장이 성장할수록 **GPU가 부족한 부분을 스토리지가 채워주는걸**을 고민하고 있었다. 스토리지 회사들이 추론 시장에 뛰어들고 NVIDIA가 새 계층까지 만드는 이유가 여기 있었다.
